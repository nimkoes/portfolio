...
maven 은 위와 같은 경우를 포함하여 다음과 같은 정책을 사용해 의존성을 관리 한다.  
　  
...
　  
  ![maven_004](https://github.com/nimkoes/nimkoes.github.io/blob/master/assets/img/milestone/study/maven_004.png?raw=true "maven_004"){: width="520px"}
　  
